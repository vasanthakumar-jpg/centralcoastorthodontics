    ...
    <div>
      ...
      <MainHeadingWithImage 
          ...
          <div className='flex flex-col justify-center items-center mx-10'>
            ...
            <p className='text-center text-base py-6'>Dr. Geoff Sudit is passionate about keeping up with the latest in orthodontic technology. He blends cutting-edge research and tools with traditional, tried-and-tested orthodontic techniques to provide patients with world-class care every time.</p>
          </div>
       <div className='border-2 border-gray-300 mx-5'>
      <Doctor images={<img 
            src="https://mintortho.com/wp-content/uploads/2024/02/dr-sudit-img-square.jpg"  
            alt="Description"
            className="w-full md:h-[700px] lg:h-[600px] mt-10 p-5"
          />} 
...
function Doctor(props) {
    return (
      <div>
        <div className="lg:flex lg:flex-row flex-col p-2">
          <div className="lg:w-1/2 w-full">
            {props.images}
          </div>
          <div className="lg:w-1/2 w-full">
            <div className=" lg:my-32">
              <h2 className="2xs:text-2xl md:text-4xl text-mintGreen font-bold mx-4 my-4 lg:text-5xl lg:leading-tight">{props.heading}</h2>
              <p className='2xs:text-sm md:text-base mx-4 lg:text-xl'>
                {props.paragraph}
              </p>
              <h2 className='2xs:text-2xl md:text-4xl text-gray-500 font-bold mx-4 my-4 lg:text-5xl lg:leading-tight'>{props.subheading}</h2>
              <p className='2xs:text-sm md:text-base mx-4 lg:text-xl'>{props.subpara}</p>
            </div>
          </div>
        </div>  
      </div>
